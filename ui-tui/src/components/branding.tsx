...
const TAG_FULL = 'Nous Research · Messenger of the Digital Gods · Customized by junkai'
const TAG_MID = 'Messenger of the Digital Gods · Customized by junkai'
const TAG_TINY = 'Customized by junkai'
const HIDE_BELOW = 34
